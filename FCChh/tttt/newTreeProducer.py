...
class TreeProducer(Analyzer):
	...
	self.tree.var('Lep_pt',float)
        ...
        for i in range(1,14):
		self.tree.var('Jet'+str(i)+'_dR_lep', float)
	...
	for i in range(1,14):
		bookParticle(self.tree,'Jet'+str(i))
	...
	### variables for lepton+jets channel
	 ...
	 #trk08 no SD
        for i in range(1,14):
		self.tree.var('Jet'+str(i)+'_trk08_tau1', float)
       		self.tree.var('Jet'+str(i)+'_trk08_tau2', float)
        	self.tree.var('Jet'+str(i)+'_trk08_tau3', float)
